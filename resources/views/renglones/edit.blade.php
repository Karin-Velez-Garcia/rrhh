        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('renglones.update', $renglone) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nombre" id="nombre" value="{{ old('nombre', $renglone->nombre) }}" 
                        ...
                        <div class="mb-4">
                            <div class="flex items-center">
                                <input type="checkbox" name="activo" id="activo" value="1" {{ old('activo', $renglone->activo) ? 'checked' : '' }}
